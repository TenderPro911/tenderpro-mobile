// src/ui/architect/steps/ReviewSubmit.jsx
...
export default function ReviewSubmit({ data = {}, prev }) {
  ...
  async function submit() {
    ...
    try {
      ...
      const res = await fetch("/api/architect", { method: "POST", body: formData });
      if (!res.ok) {
  ...
  const summary = [
    ...
    ["Floors", data.floorsPlanned],
    ["Category", data.projectCategory],
    ["Services", (data.services || []).join(", ")],
    ["Consultation", data.consultationMode],
    ["Start", data.startDate],
    ["Completion", data.completionDate],
    ["Tender close", data.tenderCloseDate],
