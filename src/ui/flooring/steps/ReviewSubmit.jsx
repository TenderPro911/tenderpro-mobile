// src/ui/flooring/steps/ReviewSubmit.jsx
...
export default function ReviewSubmit({ data = {}, prev }) {
  ...
  async function submit() {
    ...
    try {
      ...
      // Replace with full backend URL if needed (e.g., http://10.0.2.2:4000/api/flooring)
      const res = await fetch("/api/flooring", { method: "POST", body: formData });
      if (!res.ok) {
